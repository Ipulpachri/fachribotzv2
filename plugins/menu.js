...
┗━━━━━━━━···✧`.trim(),
                        ...
                        "sections": [
                            {
                                "rows": [{
                                    ...
                                    "title": "➵͜͡✪ Source Code",
                                    "description": "Script FachriBotz.",
                                    "rowId": ".sc"
                                }, {
                                    "title": "➵͜͡✪ Bot Status",
                                    "description": "Mengetahui Status Bot",
                                    "rowId": ".botstat"
                                }],
    ...
    await conn.send2ButtonLoc(m.chat, await(await fetch(image)).buffer(), text.trim(), `Runtime : ${uptime}\n${week} ${date}`, 'Owner', `${_p}owner`, 'Donasi', `${_p}donasi`, m)
  } catch (e) {
